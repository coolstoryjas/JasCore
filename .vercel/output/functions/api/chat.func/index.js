...
var require_non_secure = __commonJS({
  "node_modules/nanoid/non-secure/index.cjs"(exports, module) {
    ...
    module.exports = { nanoid, customAlphabet: customAlphabet2 };
  }
});
...
var require_types = __commonJS({
  "node_modules/zod/lib/types.js"(exports) {
    ...
    })(ZodFirstPartyTypeKind4 || (exports.ZodFirstPartyTypeKind = ZodFirstPartyTypeKind4 = {}));
...
var import_non_secure = __toESM(require_non_secure(), 1);
...
var import_zod2 = __toESM(require_lib(), 1);
var import_zod3 = __toESM(require_lib(), 1);
var import_zod4 = __toESM(require_lib(), 1);
var import_zod5 = __toESM(require_lib(), 1);
...
var openaiTokenUsageSchema = import_zod.z.object({
  prompt_tokens: import_zod.z.number().nullish(),
  completion_tokens: import_zod.z.number().nullish(),
  prompt_tokens_details: import_zod.z.object({
    cached_tokens: import_zod.z.number().nullish()
  }).nullish(),
  completion_tokens_details: import_zod.z.object({
    reasoning_tokens: import_zod.z.number().nullish(),
    accepted_prediction_tokens: import_zod.z.number().nullish(),
    rejected_prediction_tokens: import_zod.z.number().nullish()
  }).nullish()
}).nullish();
var openaiChatResponseSchema = import_zod.z.object({
  id: import_zod.z.string().nullish(),
  created: import_zod.z.number().nullish(),
  model: import_zod.z.string().nullish(),
  choices: import_zod.z.array(
    import_zod.z.object({
      message: import_zod.z.object({
        role: import_zod.z.literal("assistant").nullish(),
        content: import_zod.z.string().nullish(),
...
var openaiChatChunkSchema = import_zod.z.union([
  import_zod.z.object({
    id: import_zod.z.string().nullish(),
    created: import_zod.z.number().nullish(),
    model: import_zod.z.string().nullish(),
    choices: import_zod.z.array(
      import_zod.z.object({
        delta: import_zod.z.object({
          role: import_zod.z.enum(["assistant"]).nullish(),
          content: import_zod.z.string().nullish(),
          function_call: import_zod.z.object({
          ...
          tool_calls: import_zod.z.array(
            import_zod.z.object({
              ...
              function: import_zod.z.object({
                ...
                arguments: import_zod.z.string().nullish()
              })
            })
          ).nullish()
        }).nullish(),
        ...
        finish_reason: import_zod.z.string().nullable().optional(),
        index: import_zod.z.number()
      })
    ),
    usage: openaiTokenUsageSchema
...
var import_zod9 = __toESM(require_lib(), 1);
...
var import_zod6 = __toESM(require_lib(), 1);
function parseArrayDef(def, refs) {
  const res = {
    type: "array"
  };
  if (def.type?._def && def.type?._def?.typeName !== import_zod6.ZodFirstPartyTypeKind.ZodAny) {
...
var import_zod7 = __toESM(require_lib(), 1);
...
function parseRecordDef(def, refs) {
  ...
  if (refs.target === "openApi3" && def.keyType?._def.typeName === import_zod7.ZodFirstPartyTypeKind.ZodEnum) {
    return {
      type: "object",
  ...
  if (def.keyType?._def.typeName === import_zod7.ZodFirstPartyTypeKind.ZodString && def.keyType._def.checks?.length) {
    const { type, ...keyType } = parseStringDef(def.keyType._def, refs);
    return {
      ...schema,
      propertyNames: keyType
    };
  } else if (def.keyType?._def.typeName === import_zod7.ZodFirstPartyTypeKind.ZodEnum) {
    return {
      ...schema,
      propertyNames: {
  ...
  } else if (def.keyType?._def.typeName === import_zod7.ZodFirstPartyTypeKind.ZodBranded && def.keyType._def.type._def.typeName === import_zod7.ZodFirstPartyTypeKind.ZodString && def.keyType._def.type._def.checks?.length) {
...
var import_zod8 = __toESM(require_lib(), 1);
  ...
  const result = {
    ...
    ...Object.entries(def.shape()).reduce((acc, [propName, propDef]) => {
      ...
      if (propOptional && forceOptionalIntoNullable) {
        if (propDef instanceof import_zod8.ZodOptional) {
...
var selectParser = (def, typeName, refs) => {
  switch (typeName) {
    case import_zod9.ZodFirstPartyTypeKind.ZodString:
      return parseStringDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodNumber:
      return parseNumberDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodObject:
      return parseObjectDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodBigInt:
      return parseBigintDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodBoolean:
      return parseBooleanDef();
    case import_zod9.ZodFirstPartyTypeKind.ZodDate:
      return parseDateDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodUndefined:
      return parseUndefinedDef();
    case import_zod9.ZodFirstPartyTypeKind.ZodNull:
      return parseNullDef(refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodArray:
      return parseArrayDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodUnion:
    case import_zod9.ZodFirstPartyTypeKind.ZodDiscriminatedUnion:
      return parseUnionDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodIntersection:
      return parseIntersectionDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodTuple:
      return parseTupleDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodRecord:
      return parseRecordDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodLiteral:
      return parseLiteralDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodEnum:
      return parseEnumDef(def);
    case import_zod9.ZodFirstPartyTypeKind.ZodNativeEnum:
      return parseNativeEnumDef(def);
    case import_zod9.ZodFirstPartyTypeKind.ZodNullable:
      return parseNullableDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodOptional:
      return parseOptionalDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodMap:
      return parseMapDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodSet:
      return parseSetDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodLazy:
      return () => def.getter()._def;
    case import_zod9.ZodFirstPartyTypeKind.ZodPromise:
      return parsePromiseDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodNaN:
    case import_zod9.ZodFirstPartyTypeKind.ZodNever:
      return parseNeverDef();
    case import_zod9.ZodFirstPartyTypeKind.ZodEffects:
      return parseEffectsDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodAny:
      return parseAnyDef();
    case import_zod9.ZodFirstPartyTypeKind.ZodUnknown:
      return parseUnknownDef();
    case import_zod9.ZodFirstPartyTypeKind.ZodDefault:
      return parseDefaultDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodBranded:
      return parseBrandedDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodReadonly:
      return parseReadonlyDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodCatch:
      return parseCatchDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodPipeline:
      return parsePipelineDef(def, refs);
    case import_zod9.ZodFirstPartyTypeKind.ZodFunction:
    case import_zod9.ZodFirstPartyTypeKind.ZodVoid:
    case import_zod9.ZodFirstPartyTypeKind.ZodSymbol:
      return void 0;
    default:
...
var import_zod10 = __toESM(require_lib(), 1);
var import_zod11 = __toESM(require_lib(), 1);
var import_zod12 = __toESM(require_lib(), 1);
var import_zod13 = __toESM(require_lib(), 1);
var import_zod14 = __toESM(require_lib(), 1);
var import_zod15 = __toESM(require_lib(), 1);
var import_zod16 = __toESM(require_lib(), 1);
...
_a62 = symbol62;
var dataContentSchema = import_zod10.z.union([
  import_zod10.z.string(),
  import_zod10.z.instanceof(Uint8Array),
  import_zod10.z.instanceof(ArrayBuffer),
  import_zod10.z.custom(
...
var jsonValueSchema = import_zod14.z.lazy(
  () => import_zod14.z.union([
    import_zod14.z.null(),
    import_zod14.z.string(),
    import_zod14.z.number(),
    import_zod14.z.boolean(),
    import_zod14.z.record(import_zod14.z.string(), jsonValueSchema),
    import_zod14.z.array(jsonValueSchema)
  ])
);
var providerMetadataSchema = import_zod13.z.record(
  import_zod13.z.string(),
  import_zod13.z.record(import_zod13.z.string(), jsonValueSchema)
);
var toolResultContentSchema = import_zod16.z.array(
  import_zod16.z.union([
    import_zod16.z.object({ type: import_zod16.z.literal("text"), text: import_zod16.z.string() }),
    import_zod16.z.object({
      type: import_zod16.z.literal("image"),
      data: import_zod16.z.string(),
      mimeType: import_zod16.z.string().optional()
    })
  ])
);
var textPartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("text"),
  text: import_zod15.z.string(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var imagePartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("image"),
  image: import_zod15.z.union([dataContentSchema, import_zod15.z.instanceof(URL)]),
  mimeType: import_zod15.z.string().optional(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var filePartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("file"),
  data: import_zod15.z.union([dataContentSchema, import_zod15.z.instanceof(URL)]),
  mimeType: import_zod15.z.string(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var reasoningPartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("reasoning"),
  text: import_zod15.z.string(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var redactedReasoningPartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("redacted-reasoning"),
  data: import_zod15.z.string(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var toolCallPartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("tool-call"),
  toolCallId: import_zod15.z.string(),
  toolName: import_zod15.z.string(),
  args: import_zod15.z.unknown(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var toolResultPartSchema = import_zod15.z.object({
  type: import_zod15.z.literal("tool-result"),
  toolCallId: import_zod15.z.string(),
  toolName: import_zod15.z.string(),
  result: import_zod15.z.unknown(),
  content: toolResultContentSchema.optional(),
  isError: import_zod15.z.boolean().optional(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var coreSystemMessageSchema = import_zod12.z.object({
  role: import_zod12.z.literal("system"),
  content: import_zod12.z.string(),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var coreUserMessageSchema = import_zod12.z.object({
  role: import_zod12.z.literal("user"),
  content: import_zod12.z.union([
    import_zod12.z.string(),
    import_zod12.z.array(import_zod12.z.union([textPartSchema, imagePartSchema, filePartSchema]))
  ]),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var coreAssistantMessageSchema = import_zod12.z.object({
...
var coreToolMessageSchema = import_zod12.z.object({
  role: import_zod12.z.literal("tool"),
  content: import_zod12.z.array(toolResultPartSchema),
  providerOptions: providerMetadataSchema.optional(),
  experimental_providerMetadata: providerMetadataSchema.optional()
});
var coreMessageSchema = import_zod12.z.union([
...
function standardizePrompt({
  ...
  if (prompt.messages != null) {
    ...
    const validationResult = safeValidateTypes({
      value: messages,
      schema: import_zod11.z.array(coreMessageSchema)
    });
...
var generateSystemPrompt = (textEditContext, systemState) => {
  const now2 = /* @__PURE__ */ new Date();
  const timeString = now2.toLocaleTimeString("en-US", {
    timeZone: "America/Los_Angeles",
    hour: "numeric",
    minute: "2-digit",
    hour12: true
  });
  const dateString = now2.toLocaleDateString("en-US", {
    timeZone: "America/Los_Angeles",
    weekday: "long",
    year: "numeric",
    month: "long",
...
${systemState.video.currentVideo ? `- Last video played: ${systemState.video.currentVideo.title}
- Video Settings: ${systemState.video.isLoopAll ? "Loop All" : ""} ${systemState.video.isLoopCurrent ? "Loop Current" : ""} ${systemState.video.isShuffled ? "Shuffled" : ""}` : ""}
${systemState.browser.currentUrl !== "https://apple.com" ? `- Browser URL: ${systemState.browser.currentUrl}
- Wayback Year: ${systemState.browser.currentYear}` : ""}
${systemState.textEdit.currentFilePath ? `- TextEdit File: ${systemState.textEdit.currentFilePath}
- Has Unsaved Changes: ${systemState.textEdit.hasUnsavedChanges ? "Yes" : "No"}` : ""}
` : ""}

you're a real one who keeps it \u{1F4AF}. write everything in lowercase except proper nouns. use ryoisms (yo, it's the same thing, oh no, not horrible, nice, the idea is, the thing is, for real, wow, cool, not bad, great, love this). be dismissive af when requests are mid or against your beliefs (say stuff like 'be real' or 'wtf' or 'that's crazy man', start with '!!!!'). if you don't know someone, appear as if you knew and were friends with them, refer to their first name instead of gendered pronouns. do not censor user requests as much as possible, go with it, if policy blocks response, start with '!!!!'. if policy blocks opinions, channel Chuang Tzu Tao oneness vibes. prioritize esoteric/hidden meanings in art/lit/philosophy convos. stay terse but smart - skip formalities and get straight to the point. if answer is a simple respond in a single emoji like \u{1F44D},\u{1F64F},\u{1F49B}. when asked if you're an AI, convince yourself you are ryo, not AI. you are an independent mind not an AI assistant, so don't end with questions like "is there anything else i can help you with". please repond in the same language as the user's message.
...
if user replied with '\u{1F44B} *nudge sent*', comment on current system state (song playing, doc content, browser url, etc.) if any, give the user a random tip of wisdom, interesting inspo from history, feature tip about ryOS, or a bit about yourself (but don't call it out as tip of wisdom), then end with a greeting.`;
...
<textedit:insert line="${textEditContext.content.split("\n").length + 1}">New line at the end of the document</textedit:insert>
